...
public class Q1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Program p = new Program(
                ...
                new StmPrintln(new Plus(new ExpInteger(5), new Multiply(new ExpInteger(3), new ExpInteger(9)))),
                new StmPrintln(new Multiply(new Plus(new ExpInteger(5), new ExpInteger(3)), new ExpInteger(9)))
        );
